...
Label_result= Label(root,width=25,height=2,text="",font=("bold",25))
Label_result.pack()

Button(root,text="c", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#fff",bg="#a52a2a",command=lambda: clear()).place(x=10,y=100)
...
Button(root,text="=", width=5, height=3, font=("arial",30,"bold"), bd=1,fg="#fff",bg="#7fff00",command=lambda: calculate()).place(x=430,y=400)
